...
def rfOptimization(X_train, y_train):
    ...
    params = { #Or use param range like:  list(range(1, 10))
        ...
        "max_depth" : [3, 5, 7], #1st iteration: 7 best of [3, 5, 7]
    ...
    0.9978913394524304
    Best params 1st:
    {'criterion': 'entropy', 'max_depth': 7, 'min_samples_leaf': 1, 'min_samples_split': 1, 'min_weight_fraction_leaf': 0.0, 'n_estimators': 100}


    Best Score 2nd: 
    0.9979068421264552
    Best params 2nd:
    {'criterion': 'entropy', 'max_depth': 7, 'min_samples_leaf': 1, 'min_samples_split': 1, 'min_weight_fraction_leaf': 0.0, 'n_estimators': 90}
    """
...
def prediction(X_train, y_train, X_test):
    ...
    classifier = RandomForestClassifier(n_estimators=90, n_jobs=-1, max_depth=7, criterion="entropy")
